...
export class SongDocument {
	...
	constructor() {
		...
		ColorConfig.setTheme(this.prefs.shitbox4colorTheme);
		Layout.setLayout(this.prefs.shitbox4layout);
	...
	public getFullScreen(): boolean {
		return !this.getMobileLayout() && (this.prefs.shitbox4layout != "small");
	}
