...
export class LayoutPrompt implements Prompt {
	...
	constructor(private _doc: SongDocument) {
		...
		(<any> this._form.elements)["layout"].value = this._doc.prefs.shitbox4layout;
	}
	...
	private _confirm = (): void => { 
		this._doc.prefs.shitbox4layout = (<any> this._form.elements)["layout"].value;
		this._doc.prefs.save();
		Layout.setLayout(this._doc.prefs.shitbox4layout);
		this._close();
	}
}
